                        ...
                        <div key={`board-${key.id}`} className="board">
                            <div >
                                <div className="board-images">
                                    ...
                                    <div id={`pen-icon-${key}`} className={`pen-icon`} onClick={() => {this.props.openModal('editBoard')
                                    ( this.props.getBoard(key.id))}}><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                                        width="26" height="26"
                                        viewBox="0 0 172 172"
